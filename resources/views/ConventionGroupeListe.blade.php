...
<title>ConventiongroupesListe</title>
...
<div style="height:600px;width: 1300px;background-color: white;border-radius: 10px;margin-left: 120px;margin-top: 25px; text-align: center;">
 <div style="height:40px;width: 1300px; text-align: center;border-style:unset;background-color: #ffc107;" >
                            <label style="font-family: fantasy; font-size: 20px;">Liste des Conventions Groupes</label>
    </div>
    <!--le tableau de la liste des conventions groupes -->
 ...
 <thead>
  ...
  <tbody>
    <?php
            foreach($Conventiongroupes as $Conventiongroupes)
            echo"
                <tr>
                   
                    <td>$Conventiongroupes->nom_societe</td>
                    <td>$Conventiongroupes->date_pro</td>
                    <td >$Conventiongroupes->lieu</td>
                    <td>$Conventiongroupes->code_rang</td>
                    <td><a href='/Conventiongroupes/{$Conventiongroupes->id}/modifierconventiongroupes' style='color:black;' >Modifier</a></td>
...
function showConfirmation() {
  ...
  if (confirmation) {
    window.location.href = '/Conventiongroupes/$Conventiongroupes->id/ConventiongroupesDelete'; 
  } else {
