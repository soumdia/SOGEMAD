...
<img src="images/sogemad.png" alt="" style="height: 90px;">
		...
		<nav style=" float: right;background-color: #ffc107;height:90px;border-radius: 10px;">
			<ul style="list-style: none;">
				...
				<li style="display: inline-block; font-weight: bold;margin-right: 20px;font-family:sans-serif;"><a href="/empruntliste" style="color:black;">LISTE DES EMPRUNTS</a></li>
			</ul>
		</nav>
	</header>
...
<div style="height:600px;width: 1300px;background-color: white;border-radius: 10px;margin-left: 120px;margin-top: 25px; text-align: center;">
 <div style="height:40px;width: 1300px; text-align: center;border-style:unset;background-color: #ffc107;" >
                            <label style="font-family: fantasy; font-size: 20px;">Liste des Demandes</label>
    </div>
    <!-- la listes des demandes -->
    ...
    <?php
            ...
            echo"
                <tr>
                    ...
                    <td>$demandes->Nom</td>
                    <td>$demandes->Type_doc</td>
                    <td>$demandes->reference</td>
                    <td><a href='/Demandes/{$demandes->id}/validerDemandes' ><button  class='btn btn-success'>Valider </button></a></td>
